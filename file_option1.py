...
class Fileoption(object):
    ...
    def option(self): 
        ...
        # for k in self.expect_reward_estimate:
        #     sum=sum+k
        # for element in self.expect_reward_estimate:
        #     em=element/sum
        #     p.append(em)
        # print("self.expect_reward_estimate="+str(self.expect_reward_estimate))
        # for i in range(0,5):
        #     if i==self.best_arm:
        #         p[i]=p[i]+0.08
        #     else:
